	...
	if($_POST['title']!='' and $_POST['recip']!='' and $_POST['message']!='')
	{
		...
		if($dn1['recip']==1)
		{
			if($dn1['recipid']!=$_SESSION['userid'])
			{
				...
				{
	?>
	<div class="message">The PM has been successfully sent.<br />
...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Forum Index</a> &gt; <a href="list_pm.php">List of your PMs</a> &gt; New PM
    </div>
	<div class="box_right">
...
{
?>
<div class="message">You must be logged in to access this page.</div>
<div class="box_login">
...
?>
				<div class="foot"><a>The Information Hub</a> - <a>Samuel Mwamburi &copy;</a></div>
	</body>
</html>